/* Generated by Cython 0.15.1 on Mon Nov  4 14:14:54 2013 */
...
#endif
#include <math.h>
#define __PYX_HAVE__sens__src__run_ising_mc
#define __PYX_HAVE_API__sens__src__run_ising_mc
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'sens.src.run_ising_mc' */
__PYX_EXTERN_C DL_IMPORT(int) mcising(long *, double *, long, long, double, long, long *, long *, long *); /*proto*/
...
#define __Pyx_MODULE_NAME "sens.src.run_ising_mc"
int __pyx_module_is_main_sens__src__run_ising_mc = 0;

/* Implementation of 'sens.src.run_ising_mc' */
...
static char __pyx_k_14[] = "sens.src.run_ising_mc";
...
static char __pyx_k__nend[] = "nend";
...
static char __pyx_k__mciter[] = "mciter";
static char __pyx_k__nbegin[] = "nbegin";
static char __pyx_k____main__[] = "__main__";
static char __pyx_k____test__[] = "__test__";
static char __pyx_k__ValueError[] = "ValueError";
static char __pyx_k__mc_ising_c[] = "mc_ising_c";
static char __pyx_k__RuntimeError[] = "RuntimeError";
static char __pyx_k__neighbor_list[] = "neighbor_list";
...
static PyObject *__pyx_n_s__mc_ising_c;
static PyObject *__pyx_n_s__mciter;
static PyObject *__pyx_n_s__nbegin;
static PyObject *__pyx_n_s__neighbor_list;
static PyObject *__pyx_n_s__nend;
...
static PyObject *__pyx_pf_4sens_3src_12run_ising_mc_mc_ising_c(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_4sens_3src_12run_ising_mc_mc_ising_c = {__Pyx_NAMESTR("mc_ising_c"), (PyCFunction)__pyx_pf_4sens_3src_12run_ising_mc_mc_ising_c, METH_VARARGS|METH_KEYWORDS, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pf_4sens_3src_12run_ising_mc_mc_ising_c(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  PyArrayObject *__pyx_v_spins = 0;
  long __pyx_v_mciter;
  double __pyx_v_Emax;
  long __pyx_v_seed;
  PyArrayObject *__pyx_v_neighbor_list = 0;
  PyArrayObject *__pyx_v_nbegin = 0;
  PyArrayObject *__pyx_v_nend = 0;
  double __pyx_v_energy;
  PyArrayObject *__pyx_v_Eretarray = 0;
  int __pyx_v_naccept;
  PyObject *__pyx_v_Ereturn = NULL;
  Py_buffer __pyx_bstruct_neighbor_list;
  Py_ssize_t __pyx_bstride_0_neighbor_list = 0;
  Py_ssize_t __pyx_bshape_0_neighbor_list = 0;
  Py_buffer __pyx_bstruct_nbegin;
  Py_ssize_t __pyx_bstride_0_nbegin = 0;
  Py_ssize_t __pyx_bshape_0_nbegin = 0;
  Py_buffer __pyx_bstruct_Eretarray;
  Py_ssize_t __pyx_bstride_0_Eretarray = 0;
  Py_ssize_t __pyx_bshape_0_Eretarray = 0;
  Py_buffer __pyx_bstruct_nend;
  Py_ssize_t __pyx_bstride_0_nend = 0;
  Py_ssize_t __pyx_bshape_0_nend = 0;
  Py_buffer __pyx_bstruct_spins;
  Py_ssize_t __pyx_bstride_0_spins = 0;
  Py_ssize_t __pyx_bshape_0_spins = 0;
  ...
  int __pyx_clineno = 0;
  static PyObject **__pyx_pyargnames[] = {&__pyx_n_s__spins,&__pyx_n_s__mciter,&__pyx_n_s__Emax,&__pyx_n_s__seed,&__pyx_n_s__neighbor_list,&__pyx_n_s__nbegin,&__pyx_n_s__nend,&__pyx_n_s__energy,0};
  __Pyx_RefNannySetupContext("mc_ising_c");
  __pyx_self = __pyx_self;
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (PyTuple_GET_SIZE(__pyx_args)) {
        case  0:
        values[0] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__spins);
        if (likely(values[0])) kw_args--;
        else goto __pyx_L5_argtuple_error;
        case  1:
        values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__mciter);
        if (likely(values[1])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mc_ising_c", 1, 8, 8, 1); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  2:
        values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__Emax);
        if (likely(values[2])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mc_ising_c", 1, 8, 8, 2); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  3:
        values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__seed);
        if (likely(values[3])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mc_ising_c", 1, 8, 8, 3); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  4:
        values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__neighbor_list);
        if (likely(values[4])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mc_ising_c", 1, 8, 8, 4); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  5:
        values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__nbegin);
        if (likely(values[5])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mc_ising_c", 1, 8, 8, 5); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  6:
        values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__nend);
        if (likely(values[6])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mc_ising_c", 1, 8, 8, 6); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
        case  7:
        values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__energy);
        if (likely(values[7])) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("mc_ising_c", 1, 8, 8, 7); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, PyTuple_GET_SIZE(__pyx_args), "mc_ising_c") < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
      }
    ...
    __pyx_v_spins = ((PyArrayObject *)values[0]);
    __pyx_v_mciter = __Pyx_PyInt_AsLong(values[1]); if (unlikely((__pyx_v_mciter == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_Emax = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_Emax == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_seed = __Pyx_PyInt_AsLong(values[3]); if (unlikely((__pyx_v_seed == (long)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 12; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
    __pyx_v_neighbor_list = ((PyArrayObject *)values[4]);
    __pyx_v_nbegin = ((PyArrayObject *)values[5]);
    __pyx_v_nend = ((PyArrayObject *)values[6]);
    __pyx_v_energy = __pyx_PyFloat_AsDouble(values[7]); if (unlikely((__pyx_v_energy == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 16; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("mc_ising_c", 1, 8, 8, PyTuple_GET_SIZE(__pyx_args)); {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L3_error;}
  __pyx_L3_error:;
  __Pyx_AddTraceback("sens.src.run_ising_mc.mc_ising_c", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_bstruct_Eretarray.buf = NULL;
  __pyx_bstruct_spins.buf = NULL;
  __pyx_bstruct_neighbor_list.buf = NULL;
  __pyx_bstruct_nbegin.buf = NULL;
  __pyx_bstruct_nend.buf = NULL;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_spins), __pyx_ptype_5numpy_ndarray, 1, "spins", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_neighbor_list), __pyx_ptype_5numpy_ndarray, 1, "neighbor_list", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_nbegin), __pyx_ptype_5numpy_ndarray, 1, "nbegin", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_nend), __pyx_ptype_5numpy_ndarray, 1, "nend", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 15; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_spins, (PyObject*)__pyx_v_spins, &__Pyx_TypeInfo_long, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_spins = __pyx_bstruct_spins.strides[0];
  __pyx_bshape_0_spins = __pyx_bstruct_spins.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_neighbor_list, (PyObject*)__pyx_v_neighbor_list, &__Pyx_TypeInfo_long, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_neighbor_list = __pyx_bstruct_neighbor_list.strides[0];
  __pyx_bshape_0_neighbor_list = __pyx_bstruct_neighbor_list.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_nbegin, (PyObject*)__pyx_v_nbegin, &__Pyx_TypeInfo_long, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_nbegin = __pyx_bstruct_nbegin.strides[0];
  __pyx_bshape_0_nbegin = __pyx_bstruct_nbegin.shape[0];
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_nend, (PyObject*)__pyx_v_nend, &__Pyx_TypeInfo_long, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_nend = __pyx_bstruct_nend.strides[0];
  __pyx_bshape_0_nend = __pyx_bstruct_nend.shape[0];

  /* "sens/src/run_ising_mc.pyx":21
 * #    x = np.zeros(x0.size);
 ...
 */
  ...
  __pyx_t_2 = PyObject_GetAttr(__pyx_t_1, __pyx_n_s__zeros); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_1 = PyObject_Call(__pyx_t_2, ((PyObject *)__pyx_k_tuple_1), NULL); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_energy); if (unlikely(!__pyx_t_2)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_2);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_Eretarray);
    __pyx_t_5 = __Pyx_GetBufferAndValidate(&__pyx_bstruct_Eretarray, (PyObject*)__pyx_t_4, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack);
    if (unlikely(__pyx_t_5 < 0)) {
      PyErr_Fetch(&__pyx_t_6, &__pyx_t_7, &__pyx_t_8);
      if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_Eretarray, (PyObject*)__pyx_v_Eretarray, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {
    ...
    __pyx_bstride_0_Eretarray = __pyx_bstruct_Eretarray.strides[0];
    __pyx_bshape_0_Eretarray = __pyx_bstruct_Eretarray.shape[0];
    if (unlikely(__pyx_t_5 < 0)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_t_4 = 0;
  __pyx_v_Eretarray = ((PyArrayObject *)__pyx_t_3);
  __pyx_t_3 = 0;

  /* "sens/src/run_ising_mc.pyx":23
 *     Eretarray = np.zeros(1) + energy
 * 
 *     naccept = mcising(<long int*>spins.data, <double*> Eretarray.data, len(spins),             # <<<<<<<<<<<<<<
 *                       mciter, Emax, seed,
 ...
 */
  __pyx_t_9 = PyObject_Length(((PyObject *)__pyx_v_spins)); if (unlikely(__pyx_t_9 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 23; __pyx_clineno = __LINE__; goto __pyx_L1_error;}

  /* "sens/src/run_ising_mc.pyx":27
 *                       <long int*>neighbor_list.data,
 ...
 *     Ereturn = Eretarray[0]
 */
  __pyx_v_naccept = mcising(((long *)__pyx_v_spins->data), ((double *)__pyx_v_Eretarray->data), __pyx_t_9, __pyx_v_mciter, __pyx_v_Emax, __pyx_v_seed, ((long *)__pyx_v_neighbor_list->data), ((long *)__pyx_v_nbegin->data), ((long *)__pyx_v_nend->data));

  /* "sens/src/run_ising_mc.pyx":29
 *                       <long int*>nend.data
 *                       )
 *     Ereturn = Eretarray[0]             # <<<<<<<<<<<<<<
 ...
 */
  ...
  __pyx_t_5 = -1;
  if (__pyx_t_10 < 0) {
    __pyx_t_10 += __pyx_bshape_0_Eretarray;
    if (unlikely(__pyx_t_10 < 0)) __pyx_t_5 = 0;
  } else if (unlikely(__pyx_t_10 >= __pyx_bshape_0_Eretarray)) __pyx_t_5 = 0;
  if (unlikely(__pyx_t_5 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_5);
    {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_t_3 = PyFloat_FromDouble((*__Pyx_BufPtrCContig1d(double *, __pyx_bstruct_Eretarray.buf, __pyx_t_10, __pyx_bstride_0_Eretarray))); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 29; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_v_Ereturn = __pyx_t_3;
  __pyx_t_3 = 0;

  /* "sens/src/run_ising_mc.pyx":30
 *                       )
 *     Ereturn = Eretarray[0]
 *     return spins, Ereturn, naccept             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_3 = PyInt_FromLong(__pyx_v_naccept); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 30; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  ...
  PyTuple_SET_ITEM(__pyx_t_2, 0, ((PyObject *)__pyx_v_spins));
  __Pyx_GIVEREF(((PyObject *)__pyx_v_spins));
  __Pyx_INCREF(__pyx_v_Ereturn);
  PyTuple_SET_ITEM(__pyx_t_2, 1, __pyx_v_Ereturn);
  __Pyx_GIVEREF(__pyx_v_Ereturn);
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_neighbor_list);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_nbegin);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_Eretarray);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_nend);
    __Pyx_SafeReleaseBuffer(&__pyx_bstruct_spins);
  ...
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_spins);
  __pyx_L2:;
  __Pyx_XDECREF((PyObject *)__pyx_v_Eretarray);
  __Pyx_XDECREF(__pyx_v_Ereturn);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s__mc_ising_c, __pyx_k__mc_ising_c, sizeof(__pyx_k__mc_ising_c), 0, 0, 1, 1},
  {&__pyx_n_s__mciter, __pyx_k__mciter, sizeof(__pyx_k__mciter), 0, 0, 1, 1},
  {&__pyx_n_s__nbegin, __pyx_k__nbegin, sizeof(__pyx_k__nbegin), 0, 0, 1, 1},
  {&__pyx_n_s__neighbor_list, __pyx_k__neighbor_list, sizeof(__pyx_k__neighbor_list), 0, 0, 1, 1},
  {&__pyx_n_s__nend, __pyx_k__nend, sizeof(__pyx_k__nend), 0, 0, 1, 1},
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initrun_ising_mc(void); /*proto*/
PyMODINIT_FUNC initrun_ising_mc(void)
#else
PyMODINIT_FUNC PyInit_run_ising_mc(void); /*proto*/
PyMODINIT_FUNC PyInit_run_ising_mc(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_run_ising_mc(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("run_ising_mc"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_sens__src__run_ising_mc) {
 ...
 *                 np.ndarray[long int, ndim=1, mode="c"] neighbor_list,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4sens_3src_12run_ising_mc_mc_ising_c, NULL, __pyx_n_s_14); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s__mc_ising_c, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 11; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init sens.src.run_ising_mc", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init sens.src.run_ising_mc");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
