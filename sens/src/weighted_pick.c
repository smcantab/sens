/* Generated by Cython 0.15.1 on Mon Nov  4 14:14:55 2013 */
...
#endif
#include <math.h>
#define __PYX_HAVE__sens__src__weighted_pick
#define __PYX_HAVE_API__sens__src__weighted_pick
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'sens.src.weighted_pick' */
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), 'R' };
#define __Pyx_MODULE_NAME "sens.src.weighted_pick"
int __pyx_module_is_main_sens__src__weighted_pick = 0;

/* Implementation of 'sens.src.weighted_pick' */
static PyObject *__pyx_builtin_ValueError;
static PyObject *__pyx_builtin_xrange;
static PyObject *__pyx_builtin_range;
static PyObject *__pyx_builtin_RuntimeError;
static char __pyx_k_1[] = "weights must not have zero length";
...
static char __pyx_k_15[] = "sens.src.weighted_pick";
static char __pyx_k_16[] = "weighted_pick_cython";
...
static PyObject *__pyx_pf_4sens_3src_13weighted_pick_weighted_pick_cython(PyObject *__pyx_self, PyObject *__pyx_v_weights); /*proto*/
static PyMethodDef __pyx_mdef_4sens_3src_13weighted_pick_weighted_pick_cython = {__Pyx_NAMESTR("weighted_pick_cython"), (PyCFunction)__pyx_pf_4sens_3src_13weighted_pick_weighted_pick_cython, METH_O, __Pyx_DOCSTR(0)};
static PyObject *__pyx_pf_4sens_3src_13weighted_pick_weighted_pick_cython(PyObject *__pyx_self, PyObject *__pyx_v_weights) {
  unsigned int __pyx_v_nweights;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("weighted_pick_cython");
  __pyx_self = __pyx_self;
  __pyx_bstruct_weights.buf = NULL;
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_weights), __pyx_ptype_5numpy_ndarray, 1, "weights", 0))) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_bstruct_weights, (PyObject*)__pyx_v_weights, &__Pyx_TypeInfo_double, PyBUF_FORMAT| PyBUF_C_CONTIGUOUS, 1, 0, __pyx_stack) == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  }
  __pyx_bstride_0_weights = __pyx_bstruct_weights.strides[0];
  __pyx_bshape_0_weights = __pyx_bstruct_weights.shape[0];

  /* "sens/src/weighted_pick.pyx":8
 * @cython.boundscheck(False) # turn of bounds-checking for entire function
 * def weighted_pick_cython(np.ndarray[double, ndim=1, mode="c"] weights):
 *     cdef unsigned int nweights = len(weights)             # <<<<<<<<<<<<<<
 *     cdef unsigned int i
 *     cdef double r, s
 */
  __pyx_t_1 = PyObject_Length(__pyx_v_weights); if (unlikely(__pyx_t_1 == -1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 8; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __pyx_v_nweights = __pyx_t_1;

  /* "sens/src/weighted_pick.pyx":12
 *     cdef double r, s
 * 
 *     if nweights == 0:             # <<<<<<<<<<<<<<
 ...
 */
  __pyx_t_2 = (__pyx_v_nweights == 0);
  if (__pyx_t_2) {

    /* "sens/src/weighted_pick.pyx":13
 * 
 *     if nweights == 0:
 *         raise ValueError("weights must not have zero length")             # <<<<<<<<<<<<<<
 *     r = np.random.uniform(0., np.sum(weights))
 *     s = 0.0
 */
    __pyx_t_3 = PyObject_Call(__pyx_builtin_ValueError, ((PyObject *)__pyx_k_tuple_2), NULL); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = PyObject_GetAttr(__pyx_t_3, __pyx_n_s__random); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyObject_GetAttr(__pyx_t_4, __pyx_n_s__uniform); if (unlikely(!__pyx_t_3)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_3);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyFloat_FromDouble(0.); if (unlikely(!__pyx_t_4)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __pyx_t_6 = PyObject_GetAttr(__pyx_t_5, __pyx_n_s__sum); if (unlikely(!__pyx_t_6)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_7 = PyObject_Call(__pyx_t_6, ((PyObject *)__pyx_t_5), NULL); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  ...
  __pyx_t_4 = 0;
  __pyx_t_7 = 0;
  __pyx_t_7 = PyObject_Call(__pyx_t_3, ((PyObject *)__pyx_t_5), NULL); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __Pyx_DECREF(((PyObject *)__pyx_t_5)); __pyx_t_5 = 0;
  __pyx_t_8 = __pyx_PyFloat_AsDouble(__pyx_t_7); if (unlikely((__pyx_t_8 == (double)-1) && PyErr_Occurred())) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 14; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_7); __pyx_t_7 = 0;
  __pyx_v_r = __pyx_t_8;

  /* "sens/src/weighted_pick.pyx":15
 *         raise ValueError("weights must not have zero length")
 *     r = np.random.uniform(0., np.sum(weights))
 *     s = 0.0             # <<<<<<<<<<<<<<
 * 
 ...
 *         if r < s: break
 */
  __pyx_t_9 = __pyx_v_nweights;
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    __pyx_v_i = __pyx_t_10;

    /* "sens/src/weighted_pick.pyx":18
 * 
 *     for i in xrange(nweights):
 *         s += weights[i]             # <<<<<<<<<<<<<<
 *         if r < s: break
 ...
 */
    ...
    __pyx_v_s = (__pyx_v_s + (*__Pyx_BufPtrCContig1d(double *, __pyx_bstruct_weights.buf, __pyx_t_11, __pyx_bstride_0_weights)));

    /* "sens/src/weighted_pick.pyx":19
 *     for i in xrange(nweights):
 *         s += weights[i]
 *         if r < s: break             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  /* "sens/src/weighted_pick.pyx":21
 *         if r < s: break
 * 
 *     return i             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_7 = PyLong_FromUnsignedLong(__pyx_v_i); if (unlikely(!__pyx_t_7)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 21; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_7);
  __pyx_r = __pyx_t_7;
  __pyx_t_7 = 0;
  goto __pyx_L0;
  ...
  __Pyx_AddTraceback("sens.src.weighted_pick.weighted_pick_cython", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_bstruct_weights);
...
static int __Pyx_InitCachedBuiltins(void) {
  __pyx_builtin_ValueError = __Pyx_GetName(__pyx_b, __pyx_n_s__ValueError); if (!__pyx_builtin_ValueError) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 13; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  #if PY_MAJOR_VERSION >= 3
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initweighted_pick(void); /*proto*/
PyMODINIT_FUNC initweighted_pick(void)
#else
PyMODINIT_FUNC PyInit_weighted_pick(void); /*proto*/
PyMODINIT_FUNC PyInit_weighted_pick(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_weighted_pick(void)");
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4(__Pyx_NAMESTR("weighted_pick"), __pyx_methods, 0, 0, PYTHON_API_VERSION);
  #else
  ...
  if (__pyx_module_is_main_sens__src__weighted_pick) {
 ...
 *     cdef unsigned int i
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4sens_3src_13weighted_pick_weighted_pick_cython, NULL, __pyx_n_s_15); if (unlikely(!__pyx_t_1)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_GOTREF(__pyx_t_1);
  if (PyObject_SetAttr(__pyx_m, __pyx_n_s_16, __pyx_t_1) < 0) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 7; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_1);
  if (__pyx_m) {
    __Pyx_AddTraceback("init sens.src.weighted_pick", __pyx_clineno, __pyx_lineno, __pyx_filename);
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init sens.src.weighted_pick");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
